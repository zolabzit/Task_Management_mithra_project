...
.custom-switch {
  ...
  .custom-control-label {
    ...
    &::after {
      ...
      right: calc(#{-($custom-switch-width + $custom-control-gutter)} + #{$custom-control-indicator-border-width * 2}); // rtl
...
.custom-select {
  ...
  padding: $custom-select-padding-y $custom-select-padding-y $custom-select-padding-x ($custom-select-padding-x + $custom-select-indicator-padding); // rtl
